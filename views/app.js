...
function renderComunicados(comunicados, erros, completosSet) {
  ...
  setTimeout(persistSession, 200); // salva logo após render, com leve delay
...
function definirCartorio(botao) {
    ...
    containerBotoes.querySelectorAll('button').forEach(btn => btn.classList.remove('selected-cartorio'));
